...
error_message = ""
def validate_customer_name(req_body, error_message):
...
def validate_mob(req_body, error_message):
    for item in req_body:
...
def validate_email(req_body, error_message):
    for item in req_body:
...
def post_data():
    try:
        ...
        for item in req_body:
            ...
            if validate_customer_name(req_body, error_message):
                pass
                
            else:
                error_msg += validate_customer_name(req_body, error_message)
                item['customer_name'] = ""
                print("error_msg ---> ", error_msg)
                

            if validate_mob(req_body, error_message):
                pass
                
            else:
                error_msg += validate_mob(req_body, error_message)
                item['mob_no'] = random.randrange(1000)
                

            if validate_email(req_body, error_message):
                pass
                
            else:
                error_msg += validate_email(req_body, error_message)
                item['email'] = ""
